...
public class Chart2 extends ApplicationFrame{
	static String title;
public Chart2(String paramString){
	super(paramString);
...
private static CategoryDataset createDataset(){
	DefaultCategoryDataset localDefaultCategoryDataset = new DefaultCategoryDataset();
	        double normalEncryptionTime = 1.45E-4; 
        double memoryModuleEncryptionTime = 5.6E-6; 
	localDefaultCategoryDataset.addValue(normalEncryptionTime,"Normal Encrption Time","Normal Encrption Time");
	localDefaultCategoryDataset.addValue(memoryModuleEncryptionTime,"Memory module encyption Time","Memory module encyption Time");
...
public void windowClosing(WindowEvent we){
  ...
  {
    JFreeChart localJFreeChart = ChartFactory.createBarChart(title, "Technique Name", "Execution Time (Secs)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
