...
private static CategoryDataset createDataset(){
	...
	for(int i=0;i<UserScreen.time.size();i++){
		String arr[] = UserScreen.time.get(i).split(",");
		localDefaultCategoryDataset.addValue(Long.parseLong(arr[1]),arr[0],arr[0]);
	}
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"File Name", "Encryption Time", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
